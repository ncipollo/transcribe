...
import io.ncipollo.transcribe.api.atlassian.ConfluenceHttpClientFactory
import io.ncipollo.transcribe.api.atlassian.ConfluenceUrlParser
...
import io.ncipollo.transcribe.feature.PageMarkdownFetchFeature
import io.ncipollo.transcribe.feature.PageMarkdownUpdateFeature
import io.ncipollo.transcribe.feature.TemplateMarkdownUpdateFeature
...
class Transcribe(
    ...
    private val actionHandler: io.ncipollo.transcribe.transcriber.action.ActionHandler by lazy {
        io.ncipollo.transcribe.transcriber.action.ActionHandler(attachmentApiClient)
    }
