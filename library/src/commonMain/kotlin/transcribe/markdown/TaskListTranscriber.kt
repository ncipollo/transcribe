    ...
    override fun transcribe(
        ...
        val taskItems = input.children
            ...
            .map { itemNode ->
                ...
                val isChecked = checkBoxNode?.getTextContent(context.markdownText)?.toString()?.contains("[x]", ignoreCase = true) == true

                // Extract content (skip LIST_BULLET and CHECK_BOX)
                val contentNodes = itemNode.children.filter { child ->
